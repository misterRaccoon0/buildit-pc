      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              ListTile(
                leading: const Icon(Icons.align_vertical_bottom_sharp, color: Colors.white), 
                title: const Text('Popularity', style: TextStyle(color: Colors.white)),
                onTap: () {
              ...
              ListTile(
                ...
                title: const Text('Latest', style: TextStyle(color: Colors.white)),
                onTap: () {
              ...
              ListTile(
                ...
                title: const Text('Highly Rated', style: TextStyle(color: Colors.white)),
                onTap: () {
